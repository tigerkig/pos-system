...
var _DateRangePickerInput = require("../DateRangePicker/DateRangePickerInput");
...
const KeyboardDateInputComponent = _DateRangePickerInput.DateRangePickerInput;
...
const DesktopDateRangePicker = /*#__PURE__*/React.forwardRef(function DesktopDateRangePicker(inProps, ref) {
  ...
  const props = (0, _shared.useDateRangePickerDefaultizedProps)(inProps, 'MuiDesktopDateRangePicker');
  const [currentlySelectingRangeEnd, setCurrentlySelectingRangeEnd] = React.useState('start');
  const validationError = (0, _useDateRangeValidation.useDateRangeValidation)(props);
  const {
    pickerProps,
    inputProps,
    wrapperProps
  } = (0, _internals.usePickerState)(props, _shared.dateRangePickerValueManager);
  const {
    PopperProps,
    TransitionComponent,
    components,
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_internals.DesktopTooltipWrapper, (0, _extends2.default)({}, wrapperProps, {
