  ...
  yargs.command({
    ...
    handler: argv => {
      ...
      const licenseDetails = {
        ...
        scope: argv.scope,
        licensingModel: argv.licensingModel
      };
      console.log(`Generating new license number for order ${licenseDetails.orderNumber} with expiry date ${licenseDetails.expiryDate.toLocaleDateString()} and scope "${licenseDetails.scope}"`);
      const license = (0, _generateLicense.generateLicense)(licenseDetails);
