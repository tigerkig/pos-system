...
var _excluded = ["value", "onChange", "components", "componentsProps"];
 ...
 */
export var MobileDateRangePicker = /*#__PURE__*/React.forwardRef(function MobileDateRangePicker(inProps, ref) {
  useLicenseVerifier('x-date-pickers-pro', releaseInfo);
  var props = useDateRangePickerDefaultizedProps(inProps, 'MuiMobileDateRangePicker');
  ...
  var _usePickerState = usePickerState(pickerStateProps, dateRangePickerValueManager),
