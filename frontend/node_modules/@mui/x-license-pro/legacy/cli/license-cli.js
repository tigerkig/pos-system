...
export function licenseGenCli() {
  yargs.command({
    ...
    handler: function handler(argv) {
      ...
      console.log("Generating new license number for order ".concat(licenseDetails.orderNumber, " with expiry date ").concat(licenseDetails.expiryDate.toLocaleDateString(), " and scope \"").concat(licenseDetails.scope, "\""));
      var license = generateLicense(licenseDetails);
