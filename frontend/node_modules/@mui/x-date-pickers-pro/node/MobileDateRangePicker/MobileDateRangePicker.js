...
const PureDateInputComponent = _DateRangePickerInput.DateRangePickerInput;
...
const MobileDateRangePicker = /*#__PURE__*/React.forwardRef(function MobileDateRangePicker(inProps, ref) {
  ...
  const props = (0, _shared.useDateRangePickerDefaultizedProps)(inProps, 'MuiMobileDateRangePicker');
  const {
    value,
    onChange,
    components,
  ...
  const {
    ...
    inputProps,
    wrapperProps
  } = (0, _internals.usePickerState)(pickerStateProps, _shared.dateRangePickerValueManager);
